...
/*   Updated: 2016/06/17 16:59:18 by aperraul         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (type == 2)
		return (ft_get_spot(rtv1, list));
	else if (type == 3)
		return (ft_get_sphere(rtv1, list));
	else if (type == 4)
		return (ft_get_cylindre(rtv1, list));
	else if (type == 5)
		return (ft_get_cone(rtv1, list));
	else if (type == 6)
		return (ft_get_plan(rtv1, list));
	else if (type == 7)
		return (ft_get_cube(rtv1, list));
	return (1);
}
...
int		ft_get_obj(t_lstline **list, t_rtv1 *rtv1, int *line_nb)
{
	...
	*list = (*list)->next;
	...
	{
		if (ft_get_obj_val(rtv1, type, (*list)) != 0)
			return (ft_syntaxe_error(*line_nb));
		*list = (*list)->next;
	}
	if (type == 0)
